  ...
  module Frete
    class Servico
      ...
      AVAILABLE_SERVICES = {
        ...
        "04170" => { :type => :sedex_reverso_espelho,       :name => "SEDEX Reverso",    :description => "SEDEX reverso espelho com contrato"    },
        "40215" => { :type => :sedex_10_reverso,            :name => "SEDEX 10 Reverso", :description => "SEDEX 10 reverso com contrato"         },
        "04677" => { :type => :pac_reverso_espelho,         :name => "PAC Reverso",      :description => "PAC reverso espelho com contrato"      },
        "81043" => { :type => :e_sedex_reverso,             :name => "e-SEDEX Reverso",  :description => "e-SEDEX reverso com contrato"          }
      }.freeze
